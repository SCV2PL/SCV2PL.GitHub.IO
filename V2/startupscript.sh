...
python3 /app/import_csv_data_from_urls.py #V2
...
python3 /app/update_districts_j1_xy_d3_todaycount.py #V2

python3 /app/clear_districts_j1_xy_d3_todaycount.py #V1-CORE

python3 /app/autofill_districts_j1_xy_d3_todaycount.py #V1-CORE

python3 /app/clear_districts_date_xy.py #V1-CORE

python3 /app/update_districts_date_xy.py #V1-CORE

python3 /app/clear_avr7d10000_todaysum_xy_support.py #V1-CORE

python3 /app/update_avr7d10000_todaysum_xy_support.py #V1-CORE

python3 /app/clear_avr7d_ir28_fdr21.py #V1-CORE
# 2022-01-29 - full automation for daily updates, lines: 33, 43, 53
python3 /app/update_avr7d_ir28_fdr21.py #V1-CORE
# 2022-01-30 - full automation for daily updates, lines: 22
# python3 /home/luke_blue/Startup_Files/update_districts_avrxypl.py
# 2022-02-08 22:32:00 Evening UPGRADE_2.0_APP Complete
python3 /app/update_districts_avrxypl.py #V2
...
# 2022-02-11 10:27:00 UPGRADE_2.0_APP Complete
python3 /app/datawrapper_api_update_custom_lines.py #V2 !!! >>> SECRET <<< !!!
# python3 /home/luke_blue/Startup_Files/selenium_datawrapper.py
# 2022-02-11 10:27:00 UPGRADE_2.0_APP Complete
python3 /app/datawrapper_api_republish_set_for_epidemic_app.py #V2 !!! >>> SECRET <<< !!!

python3 /app/block_range_avr7d10000todaysumd_districtsxyf.py #V1
# 2022-01-29 - full automation for daily updates, lines: 39, 40, 55, 56, 78, 104, 125, 152
python3 /app/save_daily_sum.py #V1
...
python3 /app/datawrapper_api_update_external_data.py # V2 !!! >>> SECRET <<< !!!
