...
config_vals = ""
with open("/home/luke_blue/Startup_Files/sunday_update/config_for_update_avr7d_array_range_7d_py.yaml", "r") as cr:
...
RUN4 = [["=B"+str(b)+"", "=C"+str(b)+"", "=D"+str(b)+"", "=E"+str(b)+"", "=F"+str(b)+"", "=G"+str(b)+"",
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(a2)+'!C2")'],

        ["=C"+str(b)+"", "=D"+str(b)+"", "=E"+str(b)+"", "=F"+str(b)+"", "=G"+str(b)+"",
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(a2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(b2)+'!C2")'],

        ["=D"+str(b)+"", "=E"+str(b)+"", "=F"+str(b)+"", "=G"+str(b)+"",
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(a2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(b2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(c2)+'!C2")'],

        ["=E"+str(b)+"", "=F"+str(b)+"", "=G"+str(b)+"",
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(a2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(b2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(c2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(d2)+'!C2")'],
        ...
        ["=F"+str(b)+"", "=G"+str(b)+"",
         ...
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(c2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(d2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(e2)+'!C2")'],
        ...
        ["=G"+str(b)+"",
         ...
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(d2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(e2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(f2)+'!C2")'],
        ...
        [
         ...
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(e2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(f2)+'!C2")',
         '=IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(g2)+'!C2")']]
...
RUN5 = [[
            ...
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(a2)+'!E2"))'],

        [
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(b2)+'!I2"))',
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(b2)+'!E2"))'],

        [
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(c2)+'!I2"))',
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(c2)+'!E2"))'],

        [
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(d2)+'!I2"))',
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(d2)+'!E2"))'],

        [
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(e2)+'!I2"))',
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(e2)+'!E2"))'],

        [
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(f2)+'!I2"))',
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(f2)+'!E2"))'],

        [
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(g2)+'!I2"))',
            '=IF(H:H="","",IMPORTRANGE("https://docs.google.com/spreadsheets/d/1JshfkqgC8bLhATHHkN3D5Bto19Sp3BpMBTYuAts5z_c", "'+str(g2)+'!E2"))']]
...
config_vals['a'] = a + 7
with open("/home/luke_blue/Startup_Files/sunday_update/config_for_update_avr7d_array_range_7d_py.yaml", "w") as cw:
