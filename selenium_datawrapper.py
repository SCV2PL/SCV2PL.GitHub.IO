...
time.sleep(0.25)
browser.find_element(By.CSS_SELECTOR, '.button.svelte-wndn5c.svelte-wndn5c').click()
time.sleep(0.25)
browser.find_element(By.ID, "si-email").send_keys(username)
time.sleep(0.25)
browser.find_element(By.ID, "si-pwd").send_keys(password)
time.sleep(0.25)
browser.find_element(By.CSS_SELECTOR, '.radio, .checkbox').click()
time.sleep(0.25)
browser.find_element(By.CSS_SELECTOR, '.button.is-primary').click()
time.sleep(15)
...
time.sleep(10)
browser.find_element(By.CSS_SELECTOR, '.button-wrapper.svelte-di7o7w').click()
time.sleep(10)
...
browser.get('https://app.datawrapper.de/chart/mb9iC/describe')
time.sleep(15)
browser.get('https://app.datawrapper.de/chart/mb9iC/publish')
time.sleep(15)
browser.find_element(By.CSS_SELECTOR, '.button-wrapper.svelte-di7o7w').click()
