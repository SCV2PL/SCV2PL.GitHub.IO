...
yesterdayn = datetime.today() - timedelta(days=14)
a = yesterdayn.strftime('%Y%m%d')

yesterdayn = datetime.today() - timedelta(days=15)
b = yesterdayn.strftime('%Y%m%d')

yesterdayn = datetime.today() - timedelta(days=16)
c = yesterdayn.strftime('%Y%m%d')

yesterdayn = datetime.today() - timedelta(days=17)
d = yesterdayn.strftime('%Y%m%d')

yesterdayn = datetime.today() - timedelta(days=18)
e = yesterdayn.strftime('%Y%m%d')

yesterdayn = datetime.today() - timedelta(days=19)
f = yesterdayn.strftime('%Y%m%d')

yesterdayn = datetime.today() - timedelta(days=20)
